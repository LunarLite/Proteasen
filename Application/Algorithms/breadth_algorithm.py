...
def execute(input, d):
	...
	while chain_deque:
		# pop first chain from deque
		temp_chain = chain_deque.popleft()
		length = len(temp_chain)
		
		# determine whether to continue building or finish a chain by checking it's score
...
def checkScore(temp_chain):
	...
	# replace best_chain and best_score if the new_score is better
